...
gulp.task("default", false, ["check-install", "browser-sync"]);

gulp.task("watch", "Watch for site/theme changes", () => {
  watch(() => {
    browserSync.reload();
  });
});
...
gulp.task("browser-sync", function() {
  browserSync({
    server: {
      baseDir: "./" //対象ディレクトリ
      // index: "./examples/theming.html" //インデックスファイル
    },
    startPath: "./examples/theming.html",
    open: "external"
  });
});
